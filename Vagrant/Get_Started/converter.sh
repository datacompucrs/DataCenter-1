...
standartTor="\"tor-!\"   [function=\"leaf\" vagrant=\"eth1\" os=\"hashicorp/bionic64\" version=\"1.0.282\" memory=\"700\" config=\"./helper_scripts/config_production_switch.sh\" ]"
standartServer="\"server-!\" [function=\"host\" vagrant=\"eth3\" os=\"hashicorp/bionic64\" version=\"1.0.282\" memory=\"700\" config=\"./helper_scripts/config_production_server.sh\" ] "
