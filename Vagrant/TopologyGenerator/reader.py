...
VERSION = "0.1.0"
VAGRANT_FILE_TEMPLATE = "vgr.j2"
VAGRANT_FILE = "teste/Vagrantfile"
...
def link(left_device, left_mac, left_port, right_device, right_port):
	inv = {}

	inv['local_interface'] = left_device[1]
	inv['local_ip'] = TUNNEL_IP
	inv['local_port'] = left_port
	inv['mac'] = left_mac
	inv['remote_device'] = right_device[0]
	inv['remote_interface'] = right_device[1]
...
def parse_edge_list(edge_list, inv):
	...
	for edg in edge_list:
		...
		source_link = link(left_device, left_mac, left_port, right_device, right_port)	

		right_mac = mac_fecth(mac_list)
		destination_link = link(right_device, right_mac, right_port, left_device, left_port)
...
#testa se o argumento passado por parametro tem sufixo .dot
